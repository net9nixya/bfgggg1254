...
CONFIG = {
    'money_for_bcoins': 2_000_000_000_000_000_000_000,  # "обменять" (цена)
    
    'status_price': {  # "купить статус" (название, цена)
        1: ("Standart VIP", 150),
        2: ("Gold VIP", 300),
        3: ("Platinum VIP", 500),
        4: ("Admin Status", 1000)
    ...
    'limit_list': {  # "купить лимит" (лимит, цена)
        1: (300_000_000_000_000_000, 50),
        2: (2_000_000_000_000_000_000_000, 500),
        3: (300_000_000_000_000_000_000_000, 1500),
        4: (2_000_000_000_000_000_000_000_000, 3000),
    },
...
🔝Покупка: Купить статус [номер]

⚡️ Энергия:
    - 50 энергии | 15 B-Coin 
     🔝 Покупка: Купить флягу 1
    - 80 энергии | 35 B-Coin
...
def reg(dp: Dispatcher):
    ...
    dp.register_message_handler(buy_status, lambda message: message.text.lower().startswith('купить статус'))
